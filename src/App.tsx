  ...
  return (
    <div className="app">
      <header className="app-header">
        <div><h1>Personal Console</h1><p>Tu Trello personal que piensa en tiempo, foco y riesgo.</p></div>
        <div className="app-header__actions">
                    <button type="button" onClick={() => setPaletteOpen(true)}>Buscar (Ctrl+K)</button>
          ...
          <button type="button" onClick={() => void handleExport()}>Exportar</button>
          <label className="import-label">Importar<input type="file" accept="application/json" onChange={(e) => { const f=e.target.files?.[0]; if (f) void handleImport(f); }} /></label>
        </div>
